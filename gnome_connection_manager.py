...
class Wmain(SimpleGladeApp):
    ...
    def addTab(self, notebook, host):
        try:
            ...
            color_list.append( gtk.gdk.Color('#363636') )          # HOST
            color_list.append( gtk.gdk.Color('#ff0883') )          # SYNTAX_STRING
            color_list.append( gtk.gdk.Color('#83ff08') )          # COMMAND
            color_list.append( gtk.gdk.Color('#ff8308') )          # COMMAND_COLOR2
            color_list.append( gtk.gdk.Color('#0883ff') )          # PATH
            color_list.append( gtk.gdk.Color('#8308ff') )          # SYNTAX_VAR
            color_list.append( gtk.gdk.Color('#08ff83') )          # PROMP
            color_list.append( gtk.gdk.Color('#b6b6b6') )          #

            color_list.append( gtk.gdk.Color('#424242') )          # HOST
            color_list.append( gtk.gdk.Color('#FF1E8E') )          # SYNTAX_STRING
            color_list.append( gtk.gdk.Color('#8EFF1E') )          # COMMAND
            color_list.append( gtk.gdk.Color('#FF8E1E') )          # COMMAND_COLOR2
            color_list.append( gtk.gdk.Color('#1E8EFF') )          # PATH
            color_list.append( gtk.gdk.Color('#8E1EFF') )          # SYNTAX_VAR
            color_list.append( gtk.gdk.Color('#1EFF8E') )          # PROMP
            color_list.append( gtk.gdk.Color('#C2C2C2') )          #

            
 
            if len(fcolor)>0 and len(bcolor)>0:
                v.set_colors(gtk.gdk.Color(fcolor), gtk.gdk.Color(bcolor), color_list)

            v.set_allow_bold(False)
